...
def login():
    if request.method == 'POST':
        print("Login POST received")  # Debug print
        ...
        if not user:
            print("Username not found.")  # Debug print
        ...
        try:
            ...
            print(f"Password match: {password == decrypted_password}")  # Debug print
        except Exception as e:
            print(f"Private key or decryption error: {e}")
            return "Error reading your credentials. Please register again."
        
        if password == decrypted_password:
            generated_otp = generate_otp()
            print(f"Generated OTP for {username}: {generated_otp}")  # OTP printed here
